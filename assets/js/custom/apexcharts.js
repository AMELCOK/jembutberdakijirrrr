(function() {
	...
	const getKlienPuasId = document.getElementById('klien_puas');
	if (getKlienPuasId) {
		var options = {
			chart: {
				height: 140,
		...
		document.querySelector("#klien_puas").innerHTML = ""
		var chart = new ApexCharts(document.querySelector("#klien_puas"), options);
		chart.render();
	}
